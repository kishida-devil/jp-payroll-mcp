...
Verified against the published tables cell by cell: **4,339 assertions** on every change.
...
`test/verify.mjs` runs 4,339 assertions against a live server. The core of it compares the

...
Verified against the published tables cell by cell: **4,312 assertions** on every change.
...
`test/verify.mjs` runs 4,312 assertions against a live server. The core of it compares the

...
<p>すべて公式資料から機械的に抽出し、<strong>そこに印刷されている値と突き合わせて</strong>います。協会けんぽの保険料額表と250通り(5都道府県×50等級)、国税庁の月額表の公表2,079セル全部を照合し、変更のたびに <span class="n">4,501件</span> の検証を実行します。</p>

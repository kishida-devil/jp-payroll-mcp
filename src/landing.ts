...
<p class="lede">47都道府県の保険料率、源泉所得税、標準報酬月額の決定と改定、割増賃金、年次有給休暇、最低賃金まで。<strong>答えには根拠の条文または通知が付きます。</strong></p>

<p><span class="tag">無料枠あり</span><span class="tag">APIキー不要</span><span class="tag">MCPツール 28本</span><span class="tag">エンドポイント 43本</span><span class="tag">OpenAPI 3.0</span></p>
...
<p>すべて公式資料から機械的に抽出し、<strong>そこに印刷されている値と突き合わせて</strong>います。協会けんぽの保険料額表と250通り(5都道府県×50等級)、国税庁の月額表の公表2,079セル全部を照合し、変更のたびに <span class="n">4,579件</span> の検証を実行します。</p>
